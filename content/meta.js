export default {
  home: {
    title: "",
    description:
      "Hey, I am Jubin Ayoob. A Front-end Developer/React Developer from India who loves to design and code. I use React.js or Next.js to build the web application interfaces and the functionalities. At the moment, I am pursuing my Bachelor's degree in Computer Science.",
    image: "",
    keywords: "portfolio jubin, portfolio jb369, jubs blogs",
  },
  ...
  bookmark: {
    title: "Bookmarks -",
    description: "Bookmarked Blogs of Jubin Ayoob's blogs by you",
